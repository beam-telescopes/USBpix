...
output               Empty;
output               Fifo_Full;
output               Hamming_Error0;
output               Hamming_Error1;
output               Hamming_Error2;
output        [3:0]  L1In;
output               L1In_Counter_Error;
output        [3:0]  L1Req;
output               L1Req_Counter_Error;
output               L1Trig_Out;
output               L1_Register_Error;
output               L1_Trig_Id_Error;
output               NotFull;
output               Read;
output               ReadOut_Processor_Error;
