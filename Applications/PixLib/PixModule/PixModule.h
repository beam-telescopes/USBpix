...
namespace PixLib {
  ...
  public:
    ...
    unsigned int getFECount(){return m_fe.size();};       //returns amount of FEs.
    FEFlavour getFEFlavour(){return (FEFlavour)m_feFlavour;};
    MCCFlavour getMCCFlavour(){return (MCCFlavour)m_mccFlavour;};
