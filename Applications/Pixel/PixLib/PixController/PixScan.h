...
public:
  ...
  enum MaskStageSteps { STEPS_1, STEPS_2, STEPS_3, STEPS_4, STEPS_6, STEPS_8, STEPS_32, STEPS_336, STEPS_672, STEPS_26880, STEPS_USER};
  ...
  enum HistogramType  { OCCUPANCY = PixController::OCCUPANCY,
			...
			HIT_RATE, TRG_RATE, GDAC_OCC, CHARGE_MEAN, CHARGE_SIGMA, CHARGE_RECO_ERROR, MEAN_NOCC, NOCC, NUM_NOISY_PIXELS, MAX_HISTO_TYPES};
  ...
  enum ScanParam      { NO_PAR,  VCAL, GDAC, IF, LATENCY, TDACS, FDACS, FEI4_GR, FEI3_GR, 
			...
			AUXFREQ, IREF_PAD, INCR_LAT_TRGDEL, IOMUX_IN, STROBE_FINE_DELAY};
...
/*                         BOC_TX_BPM, BOC_TX_BPMF, BOC_BVPH, */
  enum EndLoopAction  { NO_ACTION, SCURVE_FIT, TDAC_TUNING, GDAC_TUNING, T0_SET, FDAC_TUNING,
			...
			TOT_TO_CHARGE, CALC_MEAN_NOCC, SCURVE_FAST};
...
public:
  ...
  void preset(ScanType presetName);
