...
PixScan::PixScan(ScanType presetName) {
	m_db = NULL;
	m_dbInquire = NULL;
	preset(presetName);
}
...
void PixScan::preset(ScanType presetName) {
	initConfig();
	...
	} else if (presetName == TOT_CALIB_ALT) {
		m_repetitions = 50;
		m_strobeDuration = 500;
		m_strobeFrequency = 4000;
		m_singleDCloop = true;
...
//  no longer used for FE-I4
//	m_scanTypes["TOT_CALIB"] = TOT_CALIB;
	m_scanTypes["TOT_CALIB_ALT"] = TOT_CALIB_ALT;
