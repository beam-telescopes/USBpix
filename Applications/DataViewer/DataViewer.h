...
class DataViewer : public QWidget, public Ui::DataViewer {
 ...
 public slots:
  ...
  void plotScanAvg();
  void plotQToT(bool mode);
  void plotQToTPlain(){plotQToT(false);};
  void plotQToTFit(){plotQToT(true);};
  void plotOper(bool isScan);
  void plotOperScan(){plotOper(true);};
  void plotOperItems(){plotOper(false);};
  void plotCorrel();
  void fitScan(bool QToTfit);
  void fitScan(){fitScan(false);};
  void fitQToT(){fitScan(true);};
