...
#define CS_TIME_DEMULTIPLEXER_CTRL		70
#define CS_RO_FLAGS_REG(n)		(71+(n))
#define CS_MA_FLAGS_REG		75
#define CS_RO_INPUT_SWITCH_MAP		76
#define CS_RO_CONTROL		77
#define CS_RO_CONTROL_ERASE_SRAM	  (1 << 0)
...
#define SRAM_BYTESIZE_PER_CHIP ((SRAM_BYTESIZE) / (MAX_CHIP_COUNT))
#define SRAM_WORDSIZE_PER_CHIP ((SRAM_WORDSIZE) / (MAX_CHIP_COUNT))
