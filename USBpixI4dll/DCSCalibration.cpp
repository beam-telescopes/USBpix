...
#include "DCSCalibration.h"

void addCalItem(QStandardItemModel *model, const double &currVal,
...
void addCalItem(QStandardItemModel *model, const int &currVal,
...
CalibrationWizard::CalibrationWizard(USBPixDCS *DCS, QWidget *parent)
     : QWizard(parent)
 {
	 myDCS = DCS;
...
void CalibrationWizard::updateConstants()
{
...
void CalibrationWizard::readFile()
{
...
void CalibrationWizard::writeFile()
{
	{
...
void CalibrationWizard::sampleZeroReadings()
{
	zeroVoltageRaw     = myDCS->GetVDDA1Voltage(true);
	zeroAVDDCurrentRaw = myDCS->GetVDDA1Current(true);
	zeroDVDDCurrentRaw = myDCS->GetVDDD1Current(true);
}


void CalibrationWizard::CalibrateVoltage()
{
	myDCS->CalculateGainAndOffset(0, zeroVoltageRaw, 
		                            ponLineEdit->text().toDouble(), myDCS->GetVDDA1Voltage(true), 
...
void CalibrationWizard::CalibrateAVDDCurrent()
{
...
void CalibrationWizard::CalibrateDVDDCurrent()
{
...
void CalibrationWizard::UpdateCalibrationConstantsFromTable()
{
...
void CalibrationWizard::UpdateTable()
{
...
QWizardPage * CalibrationWizard::createIntroPage()
 ...
 QWizardPage * CalibrationWizard::createVoltageCalPage()
 {
     QWizardPage *page = new QWizardPage;
 ...
 QWizardPage * CalibrationWizard::createCurrentCalPage()
 {
     QWizardPage *page = new QWizardPage;
 ...
 QWizardPage * CalibrationWizard::createNTCCalPage()
 {
     QWizardPage *page = new QWizardPage;
...
QWizardPage * CalibrationWizard::createFinalPage()
{
	QWizardPage *page = new QWizardPage;
