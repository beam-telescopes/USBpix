...
#ifndef __CDATAFILEI3_H__
#define __CDATAFILEI3_H__
...
public:
	...
	t_Str		GetString(t_Str szKey, t_Str szSection = t_Str("")); 
				// GetFloat: Return the value as a double
	double		GetFloat(t_Str szKey, t_Str szSection = t_Str(""), double def_val = 0);
	...
	bool		SetValue(t_Str szKey, t_Str szValue, 
				...
				// key if it is not found and AUTOCREATE_KEYS is active.
	bool		SetFloat(t_Str szKey, double fValue, 
						 t_Str szComment = t_Str(""), t_Str szSection = t_Str(""));
...
/////////////////////////////////////////////////////////////////////////////////
static void	Report(e_DebugLevel DebugLevel, const char *fmt, ...);
static t_Str	GetNextWord(t_Str& CommandLine);
static int		CompareNoCase(t_Str str1, t_Str str2);
static void	Trim(t_Str& szStr);
static int		WriteLn(fstream& stream,const char* fmt, ...);
