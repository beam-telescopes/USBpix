...
class PIXDECLDIR I2CDevice
{
public:
	I2CDevice(HL_I2CMaster &HL, unsigned char busAddress, unsigned char slaveAddress);
	HL_addr mHLAdd;
protected:
	HL_I2CMaster *mHL;
};
...
class I2CIO_PCA9554: public I2CDevice
{
public:
...
class PIXDECLDIR DAC_DAC7578: public I2CDevice
{
public:
...
class PIXDECLDIR ADC_MAX11644: public I2CDevice
{
public:
