 ...
 **************************************************************************/
#ifndef PIXEL_CONFIG_STRUCTURES_H	 /* multiple inclusion protection */
#define PIXEL_CONFIG_STRUCTURES_H
#include "processor.h"
...
#define N_I4_PIXEL_COLUMNS  80
#define N_I4_PIXEL_ROWS     336
#define N_I4_PIXEL_FE_CHIPS 4
...
typedef struct {
	...
	UINT32 unused2[0x6b7]; /* align module structures on convenient boundary */

} PixelModule; /* declare N_PIXEL_CONFIG_SETS structure for each of N_PIXEL_MODULES */
