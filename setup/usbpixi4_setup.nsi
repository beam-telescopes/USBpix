...
OutFile usbpixi4_5_3_0_setup.exe
...
SectionGroup "External Libraries" SECGRP0000
    ...
    install_root:
    InitPluginsDir
    inetc::get "ftp://root.cern.ch/root/root_v${INCLUDED_ROOT_VERSION}.win32.vc11.msi" "$PLUGINSDIR\root_v${INCLUDED_ROOT_VERSION}.win32.vc11.msi"
    Pop $0
    StrCmp $0 "OK" dlok
    MessageBox MB_OK|MB_ICONEXCLAMATION "Cannot find ftp://root.cern.ch/root/root_v${INCLUDED_ROOT_VERSION}.win32.vc11.msi Please check internet connection!" /SD IDOK
    Abort
    dlok:
    DetailPrint "Installing ${INCLUDED_ROOT_VERSION}"
    ExecWait 'msiexec /i "$PLUGINSDIR\root_v${INCLUDED_ROOT_VERSION}.win32.vc11.msi"'
    DetailPrint "Root ${INCLUDED_ROOT_VERSION} installed"
    #Delete /REBOOTOK "$INSTDIR\root_v5.32.00.win32.vc11.msi"
    Goto exit
